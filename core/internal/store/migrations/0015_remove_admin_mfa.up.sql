-- Remove step-up MFA for the platform-owner console (reverts 0014). The console
-- is gated by the platform_owner staff session alone.
ALTER TABLE account_sessions
    DROP COLUMN admin_elevated_until;

ALTER TABLE accounts
    DROP CONSTRAINT accounts_mfa_shape_check,
    DROP COLUMN mfa_secret,
    DROP COLUMN mfa_activated_at;
